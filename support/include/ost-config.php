...
define('SECRET_SALT','407D08C259E0240');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','ian.perks@northumberlandtourism.co.uk');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost:/tmp/mysql5.sock'); 
define('DBNAME','db488678812');
define('DBUSER','dbo488678812');
define('DBPASS','N0rthumberland2013');

#Table prefix
define('TABLE_PREFIX','ostn_');
